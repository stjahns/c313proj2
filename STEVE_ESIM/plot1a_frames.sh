...
do
    ...
    do
        ...
        # grab 2nd line (average frames sent / correct frame)
        cat output/results_K${K}_e${E} | sed -n 2p | \
            awk "{print ${E},\$1,\$2,\$3;}" \
            >> output/results_K${K}
...
gnuplot <<EOF
    ...
    set output 'plot1a_frames.eps'
    set datafile separator " "
    set xlabel "Bit Error Rate"
    set ylabel "Average Frames Sent / Correct Frame"
    plot $(echo -e $plots)
    set output
    pause -1
EOF
